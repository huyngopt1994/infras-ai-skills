...
This skill is about thinking quality and decision hygiene. Pair it with domain skills (`k8s-doctor`, `terraform`, `helm`, `github-actions`, `infra-auditor`) once the problem is framed and the next tests/actions are explicit.
